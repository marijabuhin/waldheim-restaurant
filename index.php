...
<body>
	...
	<div class="container">
		...
		<div class="header">
			<div class="header__title">
				...
				<h2 class="header__title--smaller">Café - Restaurant - Bistro</h2>
			</div>
	...
	<div id="news" class="wrapper">
		...
		<div class="wrapper__text">
			...
			<!--<object data="news.txt" type="text/plain"></object>	-->
		</div>
	</div>
	...
	<div id="galerie" class="gallery">
		<div class="section__title">
			<h1>~ Gallery ~</h1>
		</div>
		<div class="gallery__img">
		 	<img src="img/gallery.png" alt="gallery_pic" />
		 </div>
	</div>
	...
	<script src="dist/js/burger_init.js"></script>
	<script src="https://unpkg.com/leaflet@1.3.4/dist/leaflet.js"
	   integrity="sha512-nMMmRyTVoLYqjP9hrbed9S+FzjZHW5gY1TWCHA5ckwXZBadntCNs8kEqAWdrb9O7rxbCaA4lKTIWjDXZxflOcA=="
	   crossorigin="">   </script>
	<script src="dist/js/map_init.js"></script>
	<script>
