	...
	<div class="grid">
		...
		<section id="speisekarte" class="section section speisekarte">
			...
			<div class="carousel carousel--menu owl-carousel">
				<div class="carousel__item">
					<h6></h6>
					<img src="img/SP0.png" alt="speisekarte" class="carousel__img" />
				</div>

				<div class="carousel__item">
					<h6>warme Getränke</h6>
					<img src="img/SP1.png" alt="speisekarte" class="carousel__img" />
				</div>

				<div class="carousel__item">
					<h6>alkoholfreie Getränke</h6>
					<img src="img/SP2.png" alt="speisekarte" class="carousel__img" />
				</div>
				
				<div class="carousel__item">
					<h6>Säfte</h6>
					<img src="img/SP3.png" alt="speisekarte" class="carousel__img" />
				</div>
				
				<div class="carousel__item">
					<h6>Biere</h6>
					<img src="img/SP4.png" alt="speisekarte" class="carousel__img" />
				</div>
                
                <div class="carousel__item">
					<h6>Weine</h6>
					<img src="img/SP5.png" alt="speisekarte" class="carousel__img" />
				</div>

				<div class="carousel__item">
					<h6>Weine</h6>
					<img src="img/SP6.png" alt="speisekarte" class="carousel__img" />
				</div>

				<div class="carousel__item">
					<h6>Weine</h6>
					<img src="img/SP7.png" alt="speisekarte" class="carousel__img" />
				</div>
				
				<div class="carousel__item">
					<h6>Weine</h6>
					<img src="img/SP8.png" alt="speisekarte" class="carousel__img" />
				</div>
				
                <div class="carousel__item">
					<h6>Spirituosen</h6>
					<img src="img/SP9.png" alt="speisekarte" class="carousel__img" />
				</div>

				<div class="carousel__item">
					<h6>Longdrinks</h6>
					<img src="img/SP10.png" alt="speisekarte" class="carousel__img" />
				</div>

				<div class="carousel__item">
					<h6>Salate</h6>
					<img src="img/SP11.png" alt="speisekarte" class="carousel__img" />
				</div>
				
				<div class="carousel__item">
					<h6>kalte Speisen</h6>
					<img src="img/SP12.png" alt="speisekarte" class="carousel__img" />
				</div>
				
				<div class="carousel__item">
					<h6>kleine Gerichte</h6>
					<img src="img/SP13.png" alt="speisekarte" class="carousel__img" />
				</div>
                
                <div class="carousel__item">
					<h6>warme Speisen</h6>
					<img src="img/SP14.png" alt="speisekarte" class="carousel__img" />
				</div>

				<div class="carousel__item">
					<h6>warme Speisen</h6>
					<img src="img/SP15.png" alt="speisekarte" class="carousel__img" />
				</div>

				<div class="carousel__item">
					<h6>Dessert</h6>
					<img src="img/SP16.png" alt="speisekarte" class="carousel__img" />
				</div>
				
				<div class="carousel__item">
					<h6>Zusatzstoffe &amp; Allergene</h6>
					<img src="img/InhaltAllergene.png" alt="speisekarte" class="carousel__img" />
				</div>
